		...
		<br>
					...
					<tbody>
						...
						<tr class="<?php echo $row_class; ?>">
							...
							<td>
								...
								<?php } ?>	
								<!-- DELETION LINK -->
								<a href="#" class="btn btn-warning btn-xs" data-placement="top" data-toggle="tooltip" data-original-title="<?php echo get_phrase('delete');?>" onClick="confirm_modal('<?php echo base_url();?>index.php?burial/beneficiaries/<?php echo $member_row['id']; ?>/delete_beneficiary/<?php echo $b['id']; ?>');">
									<i class="fa fa-trash"></i>
								</a>
			...
			<div class="box-content">
			        ...
			        array('class' => 'form-horizontal form-bordered validate','enctype'=>'multipart/form-data'));?>
							...
							<!-- Date of Birth -->
							<div class="form-group">
								<label class="col-sm-3 control-label">Date of Birth(optionaL)</label>
								<div class="col-sm-7">
									<div class="input-group date" data-provide="datepicker"data-date-format="yyyy-mm-dd">
										<input type="text"
											class="form-control"
